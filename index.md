...
address1: "Day 1: Sorrell's Library Den, Wean Hall 4th floor" #
...
Day 2: 9:00 AM - 4:00 PM"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2018-11-27      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-11-28       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Dr. Rebecca Lowdon","Nathan Catlin"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Huajin Wang","Eric Kaltman"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["rebecca.lowdon@gmail.com","ncatlin@ufl.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2018-11-27-Carnegie-Etherpad            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 51973052800         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="where">
  ...
  <ul>
    ...
    or
    <a href="//maps.google.com/maps?q={{page.latlng1}}">Google Maps</a></li>.
    <li>{{page.address2}}.
    Get directions with
    <a href="//www.openstreetmap.org/?mlat={{page.latlng2 | replace:',','&mlon='}}&zoom=16">OpenStreetMap</a>
    or
    <a href="//maps.google.com/maps?q={{page.latlng2}}">Google Maps</a></li>.
  </ul>
</p>
{% endif %}
...
<p id="collaborative_notes">
  <h2>Etherpad</h2>We will use this <a href="{{page.collaborative_notes}}">collaborative document</a> for chatting, taking notes, and sharing URLs and bits of code.
</p>
{% endif %}
